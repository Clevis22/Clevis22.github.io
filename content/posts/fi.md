...
All images are free to use under open licenses from [Wikimedia Commons](https://commons.wikimedia.org). URLs use MD5-verified paths per the [Wikimedia Commons FAQ](https://commons.wikimedia.org/wiki/Commons:FAQ).

| Image | License | Wikimedia Commons Page |
|---|---|---|
| M2 MacBook Air Midnight | CC BY-SA 4.0 | [File:M2_Macbook_Air_Midnight_model_-_1.jpg](https://commons.wikimedia.org/wiki/File:M2_Macbook_Air_Midnight_model_-_1.jpg) |
| Colored Neural Network | CC BY-SA 3.0 | [File:Colored_neural_network.svg](https://commons.wikimedia.org/wiki/File:Colored_neural_network.svg) |
| 2021 14-inch MacBook Pro | CC BY-SA 4.0 | [File:A_2021_14-inch_Silver_MacBook_Pro.jpg](https://commons.wikimedia.org/wiki/File:A_2021_14-inch_Silver_MacBook_Pro.jpg) |
| Python Logo | PSF License | [File:Python-logo-notext.svg](https://commons.wikimedia.org/wiki/File:Python-logo-notext.svg) |
